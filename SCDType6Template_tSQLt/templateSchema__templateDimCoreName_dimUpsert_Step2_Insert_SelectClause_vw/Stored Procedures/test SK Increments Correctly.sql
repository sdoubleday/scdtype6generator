...
BEGIN
	...
	EXECUTE [TestHelpers].[DataBuilder_templateSchema_Dim_templateDimCoreName] @SK_templateDimCoreName = 1;
	EXECUTE [TestHelpers].[DataBuilder_templateSchema_Dim_templateDimCoreName] @SK_templateDimCoreName = 2;
	EXECUTE [TestHelpers].[DataBuilder_templateSchema_Dim_templateDimCoreName] @SK_templateDimCoreName = 3;
