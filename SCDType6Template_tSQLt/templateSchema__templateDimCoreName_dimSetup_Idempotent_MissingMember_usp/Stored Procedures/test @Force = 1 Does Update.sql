CREATE PROCEDURE [templateSchema__templateDimCoreName_dimSetup_Idempotent_MissingMember_usp].[test @Force = 1 Does Update]
AS
BEGIN
	--ASSEMBLE
	...
	EXECUTE [templateSchema].[templateDimCoreName_dimSetup_Idempotent_MissingMember_usp] @MissingMemberString = @NewMissingString, @MissingMemberSK = @SK, @MissingMemberNK = @NK, @Force = 1;
