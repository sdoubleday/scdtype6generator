CREATE PROCEDURE [templateSchema__templateDimCoreName_dimSetup_Idempotent_MissingMember_usp].[test IsMissing column reset to 1 every time]
AS
BEGIN
	--ASSEMBLE
	...
	SET [templateDimCoreName_IsMissing] = 0
	WHERE [SK_templateDimCoreName] < 0;
