...
AS
	...
	SET [SCD_Status] = 
		CASE
			WHEN
			dim.[NK_SourceSystemID1] IS NULL				/*NaturalKey_ReplacementPoint|NK_SourceSystemID1|AND*/
	...
	ON
	prep.[NK_SourceSystemID1] = dim.[NK_SourceSystemID1]		/*NaturalKey_ReplacementPoint|NK_SourceSystemID1|AND*/
