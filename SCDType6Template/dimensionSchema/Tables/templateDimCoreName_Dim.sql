...
(
	...
	,
	 [SampleColumnOne_Cur] VARCHAR(500) NOT NULL CONSTRAINT [df_dimensionSchema_templateDimCoreName_SampleColumnOne_Cur] DEFAULT ('*INITIALIZED ' + CONVERT(VARCHAR(500),GETDATE(),120))		/*DimensionAttribute_ReplacementPoint|SampleColumnOne|,*/
	,
	 [SampleColumnOne_Hist] VARCHAR(500) NOT NULL CONSTRAINT [df_dimensionSchema_templateDimCoreName_SampleColumnOne_Hist] DEFAULT ('*INITIALIZED ' + CONVERT(VARCHAR(500),GETDATE(),120))		/*DimensionAttribute_ReplacementPoint|SampleColumnOne|,*/
	,[SampleColumnTwo_Cur] VARCHAR(500) NOT NULL CONSTRAINT [df_dimensionSchema_templateDimCoreName_SampleColumnTwo_Cur] DEFAULT ('*INITIALIZED ' + CONVERT(VARCHAR(500),GETDATE(),120))		/*Sample*/
	,[SampleColumnTwo_Hist] VARCHAR(500) NOT NULL CONSTRAINT [df_dimensionSchema_templateDimCoreName_SampleColumnTwo_Hist] DEFAULT ('*INITIALIZED ' + CONVERT(VARCHAR(500),GETDATE(),120))		/*Sample*/
