...
(
	...
	,
	 [SampleColumnOne_Cur] VARCHAR(500) NOT NULL CONSTRAINT [df_dimensionSchema_templateDimCoreName_T1_SampleColumnOne_Cur] DEFAULT ('*UNINITIALIZED')	/*DimensionAttribute_ReplacementPoint|SampleColumnOne|,*/
	,[SampleColumnTwo_Cur] VARCHAR(500) NOT NULL CONSTRAINT [df_dimensionSchema_templateDimCoreName_T1_SampleColumnTwo_Cur] DEFAULT ('*UNINITIALIZED')	/*Sample*/
